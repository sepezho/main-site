...
import SrcHabr from "../../../Static/Img/Icons/Sidebar/SrcHabr.png";
...
import MailMe from "../../../Static/Img/Icons/Sidebar/MailMe.png";

import s from "./Style/Links.module.sass";

const items = [
	{ href: "mailto:sepezho@gmail.com", src: MailMe, isActive: false },
	...
	{
		href: "https://www.youtube.com/channel/UC4nIyTlfA6DKuF_xKtefutQ",
		src: SrcYouTube,
		isActive: false,
	},
	{ href: "https://career.habr.com/sepezho", src: SrcHabr, isActive: false },
	{ href: "https://github.com/SEPEZHO", src: SrcGithub, isActive: false },
	{
		href: "https://stackoverflow.com/users/12073046/sepezho",
		src: SrcStackOverflow,
		isActive: false,
	},
	{
		href: "https://www.codewars.com/users/sepezho",
		src: Codewars,
		isActive: false,
	},
];
		...
		<div className={s.LinksContainer}>
			{itemsState.map((item) => (
				<a href={item.href} key={item.href}>
					<img
						src={item.src}
						className={item.isActive ? s.activeImg : ""}
						alt=""
					/>
				</a>
			))}
